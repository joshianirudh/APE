# <img src="image/logo.png" alt="APE Logo" width="40" style="vertical-align: 40px; margin-right: 5px;"/> APE: Faster and Longer Context-Augmented Generation via Adaptive Parallel Encoding [ICLR 2025]
