...
def main():
    ...
    ## inscit
    prediction_file = f"/home/xinyuya2/ChatRAG-Bench/evaluation/{args.pred_folder}/inscit_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/inscit/dev.json"
    print("-"*80)
    ...
    ## topiocqa
    prediction_file = f"/home/xinyuya2/ChatRAG-Bench/evaluation/{args.pred_folder}/topiocqa_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/topiocqa/dev.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## qrecc
    prediction_file = f"/home/xinyuya2/ChatRAG-Bench/evaluation/{args.pred_folder}/qrecc_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/qrecc/test.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## quac
    prediction_file = f"/home/xinyuya2/ChatRAG-Bench/evaluation/{args.pred_folder}/quac_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/quac/test.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    #evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## doc2dial
    prediction_file = f"/home/xinyuya2/ChatRAG-Bench/evaluation/{args.pred_folder}/doc2dial_output.txt"    # e.g., outputs/doc2idal_output.txt
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/doc2dial/test.json"     # e.g., data/doc2dial/test.json
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    '''
    ## coqa
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/coqa_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/coqa/dev.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## hybridial
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/hybridial_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/hybridial/test.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## sqa
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/sqa_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/sqa/test.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## doqa_cooking
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/doqa_cooking_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/doqa/test_cooking.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## doqa_travel
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/doqa_travel_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/doqa/test_travel.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## doqa_movies
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results_new/doqa_movies_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/doqa/test_movies.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
    evaluate_f1(ground_truth_file, prediction_file)
    ...
    ## convfinqa
    prediction_file = "/home/xinyuya2/ChatRAG-Bench/evaluation/results/convfinqa_output.txt"
    ground_truth_file = "/home/xinyuya2/ChatRAG-Bench/data/convfinqa/dev.json"
    print("-"*80)
    print(prediction_file)
    print(ground_truth_file)
