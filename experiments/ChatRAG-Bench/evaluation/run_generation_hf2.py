...
from dataset import load_data, get_inputs, get_inputs_retrival, get_inputs_retrival2
import torch
import os
import json
...
def pred(rank, world_size, prompt_list, max_length, tokenizer, model, bos_token, args):
    ...
    prompt_list = get_inputs_retrival2(prompt_list, args.eval_dataset, tokenizer, num_ctx=args.num_ctx, max_output_len=args.out_seq_len)
    output_list = []
